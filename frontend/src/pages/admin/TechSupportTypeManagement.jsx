          ...
          <table className="min-w-full divide-y divide-slate-200 text-sm">
            <thead className="bg-slate-50">
              <tr>
                ...
                <th className="px-3 py-2 text-left font-semibold text-slate-600">Tên loại kỹ thuật viên</th>
                <th className="px-3 py-2 text-left font-semibold text-slate-600">Loại thiết bị đang dùng</th>
                <th className="px-3 py-2 text-left font-semibold text-slate-600">Tài khoản kỹ thuật viên</th>
